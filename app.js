...
const showImages = (images) => {
  ...
  images.forEach(image => {
    ...
    div.innerHTML = ` <img class="img-fluid img-thumbnail img" onclick=selectItem(event,"${image.webformatURL}") src="${image.webformatURL}" alt="${image.tags}">`;
...
sliderBtn.addEventListener('click', function () {
  ...
  else if(duration.value < 1000){
    alert("Duration is too fast to see!")
    duration.value = 1000
  }
  else{
    createSlider()
